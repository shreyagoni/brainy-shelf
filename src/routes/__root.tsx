...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "StudyMate helps you save notes and PDFs in one place, synced to your account." },
      { property: "og:title", content: "StudyMate — Your notes & PDFs, organized" },
      { property: "og:description", content: "Save notes and PDFs in one place, synced to your account." },
